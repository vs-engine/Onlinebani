...
class OnlinebaniHomeManagerController extends modExtraManagerController
{
    ...
    public function loadCustomCssJs()
    {
        ...
        $this->addJavascript($this->Onlinebani->config['jsUrl'] . 'mgr/widgets/regions_city.grid.js');
        $this->addJavascript($this->Onlinebani->config['jsUrl'] . 'mgr/widgets/regions_city.windows.js');
