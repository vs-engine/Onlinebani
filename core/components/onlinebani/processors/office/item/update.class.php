...
class OnlinebaniOfficeItemUpdateProcessor extends modObjectUpdateProcessor
{
    ...
    public function beforeSet()
    {
        ...
        if (empty($id)) {
            return $this->modx->lexicon('onlinebani_item_err_ns');
        }
...
return 'OnlinebaniOfficeItemUpdateProcessor';
